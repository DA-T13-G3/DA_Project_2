...
// Assumindo que a definição da tua classe Graph e da função graphColoring
// estão incluídas aqui em cima (ex: #include "Graph.h")
...
void test1() {
    ...
    printf("Test 1 (Estrela/Bipartido)  - Esperado: 2 | Resultado: %d\n", graphColoring(&g));
}
...
void test2() {
    ...
    printf("Test 2 (Ciclo Impar)        - Esperado: 3 | Resultado: %d\n", graphColoring(&g));
}
...
void test3() {
    ...
    printf("Test 3 (Totalmente Solto)   - Esperado: 1 | Resultado: %d\n", graphColoring(&g));
}
...
void test4() {
    ...
    // Componente 2
    g.addEdge(2, 3, 0); g.addEdge(3, 2, 0);
    printf("Test 4 (Comp. Separados)    - Esperado: 2 | Resultado: %d\n", graphColoring(&g));
}
...
void test5() {
    ...
    printf("Test 5 (Grafo Completo)     - Esperado: 4 | Resultado: %d\n", graphColoring(&g));
}
...
void test6() {
    ...
    printf("Test  6 (Ciclo Par)         - Esperado: 2 | Resultado: %d\n", graphColoring(&g));
}
...
void test7() {
    ...
    printf("Test  7 (Arvore)            - Esperado: 2 | Resultado: %d\n", graphColoring(&g));
}

void test8() {
    // 8. Grafo Roda c/ ciclo impar (Esperado: 4 cores)
    // 1 vertice central (0) e um ciclo de 5 vertices em redor (1 a 5)
    Graph<int> g;
    ...
    printf("Test  8 (Grafo Roda)        - Esperado: 4 | Resultado: %d\n", graphColoring(&g));
}
...
void test9() {
    ...
    printf("Test  9 (Grelha 3x3)        - Esperado: 2 | Resultado: %d\n", graphColoring(&g));
}
...
void test10() {
    ...
    printf("Test 10 (Caminho/Linha)     - Esperado: 2 | Resultado: %d\n", graphColoring(&g));
}
...
void test11() {
    ...
    printf("Test 11 (Grafo Petersen)    - Esperado: 3 | Resultado: %d\n", graphColoring(&g));
}
...
void test12() {
    ...
    printf("Test 12 (So 1 Vertice)      - Esperado: 1 | Resultado: %d\n", graphColoring(&g));
}
...
void test13() {
    ...
    printf("Test 13 (Bipartido K_3,3)   - Esperado: 2 | Resultado: %d\n", graphColoring(&g));
}
...
void test14() {
    ...
    printf("Test 14 (Prisma Triangular) - Esperado: 3 | Resultado: %d\n", graphColoring(&g));
}
...
void test15() {
    ...
    // Grupo U: 0..3 | Grupo V: 4..7
    // Liga todos de U a todos de V, EXCETO i com i+4
    for(int i = 0; i < 4; i++) {
        for(int j = 4; j < 8; j++) {
            if(j != i + 4) {
                g.addEdge(i, j, 0); g.addEdge(j, i, 0);
    ...
    printf("Test 15 (Grafo Coroa)       - Esperado: 2 | Resultado: %d\n", graphColoring(&g));
}

void test16() {
    // 16. Grafo de Grotzsch (Esperado: 4 cores)
    // Famoso por nao ter triangulos mas exigir 4 cores.
    Graph<int> g;
    for(int i = 0; i < 11; i++) g.addVertex(i);

    // Ciclo externo v (0 a 4)
    for(int i = 0; i < 5; i++) {
        g.addEdge(i, (i+1)%5, 0); g.addEdge((i+1)%5, i, 0);
    }
    // Vertices internos u (5 a 9) ligam aos vizinhos de v_i
    for(int i = 0; i < 5; i++) {
        int u = i + 5;
        int v_prev = (i + 4) % 5;
        int v_next = (i + 1) % 5;
    ...
    // Vertice central w (10) liga a todos os u (5 a 9)
    for(int i = 5; i <= 9; i++) {
        g.addEdge(10, i, 0); g.addEdge(i, 10, 0);
    }
    printf("Test 16 (Grafo Grotzsch)    - Esperado: 4 | Resultado: %d\n", graphColoring(&g));
}
...
void test17() {
    ...
    // Ligar vertices opostos
    for(int i = 0; i < 4; i++) {
        g.addEdge(i, i+4, 0); g.addEdge(i+4, i, 0);
    }
    printf("Test 17 (Escada Mobius)     - Esperado: 3 | Resultado: %d\n", graphColoring(&g));
}

void test18() {
    // 18. Grafo Engrenagem (Esperado: 3 cores)
    Graph<int> g;
    for(int i = 0; i < 9; i++) g.addVertex(i); // 0 eh centro, 1 a 8 eh o ciclo exterior

    // Liga o centro (0) apenas as posicoes impares do ciclo (1, 3, 5, 7)
    for(int i = 1; i <= 7; i+=2) {
        g.addEdge(0, i, 0); g.addEdge(i, 0, 0);
    }
    // Ciclo alternando base e dente da engrenagem
    for(int i = 1; i <= 8; i++) {
        int next = (i % 8) + 1;
        g.addEdge(i, next, 0); g.addEdge(next, i, 0);
    }
    printf("Test 18 (Engrenagem)        - Esperado: 2 | Resultado: %d\n", graphColoring(&g));
}
...
void test19() {
    ...
    // 3 Grupos: A(0,1,2,3), B(4,5,6), C(7,8,9)
    for(int i = 0; i < 10; i++) {
        for(int j = i + 1; j < 10; j++) {
            int group_i = (i < 4) ? 0 : ((i < 7) ? 1 : 2);
            int group_j = (j < 4) ? 0 : ((j < 7) ? 1 : 2);

            // So havera aresta se pertencerem a grupos diferentes
            if(group_i != group_j) {
                g.addEdge(i, j, 0); g.addEdge(j, i, 0);
            }
        }
    }
    printf("Test 19 (Turan T(10,3))     - Esperado: 3 | Resultado: %d\n", graphColoring(&g));
}
...
void test20() {
    ...
    // Componente 1: Grafo Completo K_4 (0 a 3) - Precisa 4 cores
    for(int i = 0; i < 4; i++) {
        for(int j = i + 1; j < 4; j++) {
            g.addEdge(i, j, 0); g.addEdge(j, i, 0);
        }
    }
    // Componente 2: Ciclo Impar C_5 (4 a 8) - Precisa 3 cores
    g.addEdge(4, 5, 0); g.addEdge(5, 4, 0);
    ...
    // Componente 3: Estrela (9 no centro, 10 a 13 pontas) - Precisa 2 cores
    for(int i = 10; i <= 13; i++) {
        g.addEdge(9, i, 0); g.addEdge(i, 9, 0);
    }
    printf("Test 20 (Multicomponente)   - Esperado: 4 | Resultado: %d\n", graphColoring(&g));
}
