 ...
 * To make this function run in a practical timeframe, it tries to spill only a certain fixed
 * number of combinations of webs, which significantly decreases its time complexity. It starts by trying
